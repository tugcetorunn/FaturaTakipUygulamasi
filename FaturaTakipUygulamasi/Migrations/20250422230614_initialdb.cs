    ...
    public partial class initialdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FaturaUrun", x => new { x.FaturaId, x.UrunId });
                    table.ForeignKey(
                        name: "FK_FaturaUrun_Faturalar_FaturaId",
                        column: x => x.FaturaId,
                        principalTable: "Faturalar",
                        principalColumn: "FaturaId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FaturaUrun_Urunler_UrunId",
                        column: x => x.UrunId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "21e2c182-d8fb-4f9b-8e98-a01f477ab5b4", 0, "Ahmet", "40402924-95ce-4fdf-9b54-6e1ac6a36098", "admin@mail.com", false, false, null, "ADMİN@MAİL.COM", "ADMIN", "AQAAAAIAAYagAAAAEGAhJhAQxVQXlyCntonZWfpAMSVh0cOH7VNF4cncDnIiIFaqq2yW1AyaU+Ls1ZZeJA==", null, false, "117f44ae-744d-432e-bbd8-de7626ecc457", "Yılmaz", false, "admin" });

            migrationBuilder.InsertData(
                table: "Musteriler",
                columns: new[] { "MusteriId", "MusteriAdi", "MusteriSoyadi", "Telefon", "VergiDairesi", "VergiNo" },
                values: new object[,]
                {
                    { 1, "Ali", "Veli", "05551234567", "İstanbul", "1234567890" },
                    { 2, "Faruk", "Kılıç", "05531234567", "Bursa", "2234567890" }
                });

            migrationBuilder.InsertData(
                table: "Urunler",
                columns: new[] { "UrunId", "BirimFiyati", "StokMiktari", "UrunAdi" },
                values: new object[,]
                {
                    { 1, 25m, 100, "Mavi tükenmez kalem" },
                    { 2, 57m, 50, "A4 boyutunda defter" },
                    { 3, 5100m, 25, "Bluetooth kulaklık" }
                });
